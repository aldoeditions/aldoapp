...
const data = buildContractData({
  ...
  oeuvres: [
    { title: "Fougères #1", format: "A3", fileInfo: "JPEG · 300 DPI · 2,0 Mo", createdAt: "12/02/2026" },
    { title: "Monstera", format: "A4", fileInfo: "TIFF · 300 DPI · 8,4 Mo", createdAt: "20/02/2026" },
  ],
  commissionPct: 30,
